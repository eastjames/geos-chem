...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_CH3CCl3 = 8 
  INTEGER, PARAMETER :: ind_DummyMCF = 9 
...
!   C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_DummyCH4 = 15 
  INTEGER, PARAMETER :: ind_DummyNMVOC = 16 
